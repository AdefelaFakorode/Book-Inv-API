...
app.post("/books", async (req, res) => {
  ...
  try {
    const newBook = await query(
      `INSERT INTO books (title, author, isbn13, availability) VALUES ($1, $2, $3, $4) RETURNING *`,
...
app.patch("/books/:id", async (req, res) => {
  ...
  try {
    const bookUpdated = await query(
      `UPDATE books SET title = $1, author = $2, isbn13 = $3, availability = $4 WHERE id = $5 RETURNING *`,
